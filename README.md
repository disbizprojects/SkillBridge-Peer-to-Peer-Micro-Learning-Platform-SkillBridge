...
For detailed information about the platform, see All details.txt
...
Backend Status: Check the floating status indicator in the bottom-right corner of any page.
...
🚀 Next Steps
    ...
    Complete onboarding (select skills)
    Browse courses in Explore
    Enroll in a course or book a session
...
Read the full documentation in All details.txt
